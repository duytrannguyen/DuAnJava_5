			...
			<div class="row">
				<div class="col-lg-6 align-self-center">
					<div class="header-text">
						...
						<p>QLBook Store là một nơi hoàn hảo để bạn có thể tìm kiếm tất
					...
					<div class="collections">
						...
						<div class="owl-collection owl-carousel">
							<c:forEach var="p" items="${products}">
								<div class="item">
									<img src="/Image_SP/${p.imageId.imageName}" alt=""
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="item second-item">
						...
						<p>Phần sách giảm giá của chúng tôi cung cấp mức giá tuyệt vời
							cho những cuốn sách phổ biến, vì vậy bạn có thể thưởng thức những
							cuốn sách yêu thích của mình mà không phải tốn nhiều tiền.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="item">
