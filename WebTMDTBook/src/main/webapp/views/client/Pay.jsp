					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="shipping_id"
							...
							class="form-check-label" for="exampleRadios1"> <strong>Giao
								hàng tiêu chuẩn: 32.000 VNĐ</strong><br> <span
							style="font-size: small;">Thứ 6 - 25/6</span>
						</label>
					</div>
				</div>
				<div class="card">
				...
				<div class="card" style="margin-bottom: 250px;">
					...
					<div class="col-md-12">
						<c:forEach var="item" items="${cartItems}">
							<div class="row">
								<div class="col-md-2">
									<img src="/images/${item.product_id.imageId.imageName}"
										style="width: 150px; height: 150px;">
								</div>
								<div class="col-md-5">
									<span>${item.product_id.productName}</span>
								</div>
								<div class="col-md-1">
									<span>${item.quantity}</span>
								</div>
								<div class="col-md-2">
									<span><fmt:formatNumber> ${item.product_id.price}</fmt:formatNumber>VNĐ</span><br>
									<input type="hidden"> <span
										class="giaGiam text-body-tertiary"><fmt:formatNumber> ${item.product_id.price}</fmt:formatNumber>VNĐ</span>
								</div>
								<div class="col-md-2">
									<span class="text-primary fw-bold"><fmt:formatNumber>${item.product_id.price * item.quantity}</fmt:formatNumber>VNĐ</span>
								</div>
							</div>
							<hr>
						</c:forEach>
