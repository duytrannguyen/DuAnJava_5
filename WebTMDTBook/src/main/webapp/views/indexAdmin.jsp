		...
		<aside
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					...
					<li class="nav-item"><a class="nav-link" href="/admin/index"> <i
					...
					<li class="nav-item"><a class="nav-link" href="/admin/report"> <i
							class="bi bi-bag"></i><span>Order</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="/admin/Category"> <i
							class="bi bi-receipt"></i><span>Category</span>
					</a></li>
